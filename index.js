...
async function registerCommands() {
  ...
  const baseCommands = withTeacherScheduleCommands(commandJSON.filter((command) => command.name !== 'npc'));
  const allCommands = [...baseCommands, npcCommandJSON];
  await client.application.commands.set(allCommands);
  console.log(`Registered ${allCommands.length} global Campus commands.`);
}
