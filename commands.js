  ...
  new SlashCommandBuilder()
    ...
    .addSubcommand((sub) =>
      sub
        ...
        .addStringOption((o) =>
          o.setName('personality').setDescription('How this teacher acts.').setRequired(true))
        .addStringOption((o) =>
          o.setName('grade').setDescription('Grade level.').setRequired(false))
        .addStringOption((o) =>
          o.setName('teaching_style').setDescription('How this teacher teaches.').setRequired(false))
        .addIntegerOption((o) =>
          o.setName('strictness').setDescription('1-10').setMinValue(1).setMaxValue(10))
        .addIntegerOption((o) =>
          o.setName('talkativeness').setDescription('1-10').setMinValue(1).setMaxValue(10))
        .addIntegerOption((o) =>
          o.setName('humor').setDescription('1-10').setMinValue(1).setMaxValue(10))
        .addIntegerOption((o) =>
          o.setName('patience').setDescription('1-10').setMinValue(1).setMaxValue(10))
    )
    .addSubcommand((sub) =>
      sub
        .setName('edit')
        ...
        .addStringOption((o) =>
          o.setName('name').setDescription('Current teacher name.').setRequired(true))
        .addStringOption((o) =>
          o.setName('new_name').setDescription('New teacher name.'))
        .addStringOption((o) =>
          o.setName('subject').setDescription('New subject.'))
        .addStringOption((o) =>
          o.setName('grade').setDescription('New grade level.'))
        .addStringOption((o) =>
          o.setName('personality').setDescription('New personality.'))
        .addStringOption((o) =>
          o.setName('teaching_style').setDescription('New teaching style.'))
        .addChannelOption((o) =>
